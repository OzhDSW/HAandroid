...
import io.altenems.companion.android.common.sensors.AndroidOsSensorManager
import io.altenems.companion.android.common.sensors.AudioSensorManager
import io.altenems.companion.android.common.sensors.BatterySensorManager
import io.altenems.companion.android.common.sensors.BluetoothSensorManager
import io.altenems.companion.android.common.sensors.DNDSensorManager
import io.altenems.companion.android.common.sensors.DisplaySensorManager
import io.altenems.companion.android.common.sensors.KeyguardSensorManager
import io.altenems.companion.android.common.sensors.LastRebootSensorManager
import io.altenems.companion.android.common.sensors.LastUpdateManager
import io.altenems.companion.android.common.sensors.LightSensorManager
import io.altenems.companion.android.common.sensors.MobileDataManager
import io.altenems.companion.android.common.sensors.NetworkSensorManager
import io.altenems.companion.android.common.sensors.NextAlarmManager
import io.altenems.companion.android.common.sensors.NfcSensorManager
import io.altenems.companion.android.common.sensors.PhoneStateSensorManager
import io.altenems.companion.android.common.sensors.PowerSensorManager
import io.altenems.companion.android.common.sensors.PressureSensorManager
import io.altenems.companion.android.common.sensors.ProximitySensorManager
import io.altenems.companion.android.common.sensors.SensorManager
import io.altenems.companion.android.common.sensors.SensorReceiverBase
import io.altenems.companion.android.common.sensors.StepsSensorManager
import io.altenems.companion.android.common.sensors.StorageSensorManager
import io.altenems.companion.android.common.sensors.TimeZoneManager
import io.altenems.companion.android.common.sensors.TrafficStatsManager
import io.altenems.companion.android.home.HomeActivity
import io.altenems.companion.android.home.views.DEEPLINK_SENSOR_MANAGER
...
class SensorReceiver : SensorReceiverBase() {
    ...
    companion object {
        ...
        const val ACTION_REQUEST_SENSORS_UPDATE =
            "io.altenems.companion.android.background.REQUEST_SENSORS_UPDATE"
