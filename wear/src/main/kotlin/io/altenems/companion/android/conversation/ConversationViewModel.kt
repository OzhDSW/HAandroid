package io.altenems.companion.android.conversation
...
import io.altenems.companion.android.common.assist.AssistEvent
import io.altenems.companion.android.common.assist.AssistViewModelBase
...
import io.altenems.companion.android.conversation.views.AssistMessage
...
class ConversationViewModel @AssistedInject constructor(
    ...
    private suspend fun checkAssistSupport(): Boolean? {
        ...
        val onConversationVersion = serverManager.integrationRepository().isaltenemsVersionAtLeast(2023, 1, 0)
        val onPipelineVersion = serverManager.integrationRepository().isaltenemsVersionAtLeast(2023, 5, 0)
