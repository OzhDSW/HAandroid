...
import io.altenems.companion.android.common.util.CHANNEL_WEBSOCKET
import io.altenems.companion.android.common.util.CHANNEL_WEBSOCKET_ISSUES
...
class WebsocketManager(appContext: Context, workerParams: WorkerParameters) :
    ...
    private suspend fun createNotification(): Boolean {
        ...
        val notification = NotificationCompat.Builder(applicationContext, CHANNEL_WEBSOCKET)
            ...
            .addAction(
                io.altenems.companion.android.R.drawable.ic_websocket,
