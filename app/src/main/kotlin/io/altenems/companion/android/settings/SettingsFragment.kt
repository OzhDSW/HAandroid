...
import io.altenems.companion.android.common.util.isIgnoringBatteryOptimizations
import io.altenems.companion.android.common.util.maybeAskForIgnoringBatteryOptimizations
import io.altenems.companion.android.database.server.Server
import io.altenems.companion.android.launch.intentLaunchOnboarding
import io.altenems.companion.android.nfc.NfcSetupActivity
import io.altenems.companion.android.settings.assist.AssistSettingsFragment
import io.altenems.companion.android.settings.assist.DefaultAssistantManager
import io.altenems.companion.android.settings.controls.ManageControlsSettingsFragment
import io.altenems.companion.android.settings.developer.DeveloperSettingsFragment
import io.altenems.companion.android.settings.gestures.GesturesFragment
import io.altenems.companion.android.settings.language.LanguagesProvider
import io.altenems.companion.android.settings.license.LicensesFragment
import io.altenems.companion.android.settings.notification.NotificationChannelFragment
import io.altenems.companion.android.settings.notification.NotificationHistoryFragment
import io.altenems.companion.android.settings.qs.ManageTilesFragment
import io.altenems.companion.android.settings.sensor.SensorSettingsFragment
import io.altenems.companion.android.settings.sensor.SensorUpdateFrequencyFragment
import io.altenems.companion.android.settings.server.ServerSettingsFragment
import io.altenems.companion.android.settings.shortcuts.ManageShortcutsSettingsFragment
import io.altenems.companion.android.settings.vehicle.ManageAndroidAutoSettingsFragment
import io.altenems.companion.android.settings.wear.SettingsWearActivity
import io.altenems.companion.android.settings.wear.SettingsWearDetection
import io.altenems.companion.android.settings.widgets.ManageWidgetsSettingsFragment
import io.altenems.companion.android.util.QuestUtil
import io.altenems.companion.android.util.applyBottomSafeDrawingInsets
