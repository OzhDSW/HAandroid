package io.altenems.companion.android.settings.log
...
import io.altenems.companion.android.util.LogcatReader
import io.altenems.companion.android.util.applyBottomSafeDrawingInsets
import io.altenems.companion.android.util.getLatestFatalCrash
import java.io.File
        ...
        AlertDialog.Builder(requireActivity())
            ...
            .setPositiveButton(commonR.string.confirm_positive) { _, _ ->
                ...
                val filePathWithoutExt =
                    path + "/altenems_companion_log_$month-$day-$year" + "_" + "$hour-$minute-$second"
