...
import io.altenems.companion.android.assist.ui.AssistMessage
import io.altenems.companion.android.assist.ui.AssistUiPipeline
    ...
    private suspend fun checkSupport(): Boolean? {
        ...
        return try {
            if (!serverManager.integrationRepository(
                    selectedServerId,
                ).isaltenemsVersionAtLeast(2023, 5, 0)
            ) {
                false
            } else {
