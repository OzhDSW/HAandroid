package io.altenems.companion.android.webview.externalbus
...
class NavigateTo(path: String, replace: Boolean = false) :
    ...
    companion object {
        fun isAvailable(altenemsVersion: altenemsVersion?): Boolean {
            return altenemsVersion?.isAtLeast(2025, 6, 0) == true
        }
    }
}
