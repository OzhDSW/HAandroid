package io.altenems.companion.android.controls
...
import io.altenems.companion.android.common.data.integration.applyCompressedStateDiff
...
class HaControlsProviderService : ControlsProviderService() {
    ...
    private suspend fun subscribeToEntitiesForServer(
        ...
        if (serverManager.integrationRepository(serverId).isaltenemsVersionAtLeast(2022, 4, 0)) {
