...
import io.altenems.companion.android.util.getAttribute
import io.altenems.companion.android.util.icondialog.getIconByMdiName
import io.altenems.companion.android.widgets.ACTION_APPWIDGET_CREATED
import io.altenems.companion.android.widgets.BaseWidgetProvider
import io.altenems.companion.android.widgets.EXTRA_WIDGET_ENTITY
import io.altenems.companion.android.widgets.common.WidgetAuthenticationActivity
...
class ButtonWidget : AppWidgetProvider() {
    companion object {
        const val CALL_SERVICE =
            "io.altenems.companion.android.widgets.button.ButtonWidget.CALL_SERVICE"
        private const val CALL_SERVICE_AUTH =
            "io.altenems.companion.android.widgets.button.ButtonWidget.CALL_SERVICE_AUTH"
