...
import io.altenems.companion.android.util.delayFirstThrottle
import java.net.URL
 ...
 */
data class ServerDiscovered(val name: String, val url: URL, val version: altenemsVersion) : DiscoveryState
 ...
 * It uses [altenemsSearcher] to find instances on the local network
...
internal class ServerDiscoveryViewModel @VisibleForTesting constructor(
    ...
    private val searcher: altenemsSearcher,
