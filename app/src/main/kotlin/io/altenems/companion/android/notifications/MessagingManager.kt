package io.altenems.companion.android.notifications
...
import io.altenems.companion.android.common.notifications.DeviceCommandData
import io.altenems.companion.android.common.notifications.NotificationData
import io.altenems.companion.android.common.notifications.clearNotification
import io.altenems.companion.android.common.notifications.commandBeaconMonitor
import io.altenems.companion.android.common.notifications.commandBleTransmitter
import io.altenems.companion.android.common.notifications.createChannelID
import io.altenems.companion.android.common.notifications.getGroupNotificationBuilder
import io.altenems.companion.android.common.notifications.handleChannel
import io.altenems.companion.android.common.notifications.handleColor
import io.altenems.companion.android.common.notifications.handleDeleteIntent
import io.altenems.companion.android.common.notifications.handleSmallIcon
import io.altenems.companion.android.common.notifications.handleText
import io.altenems.companion.android.common.notifications.parseColor
import io.altenems.companion.android.common.notifications.parseVibrationPattern
import io.altenems.companion.android.common.notifications.prepareText
import io.altenems.companion.android.common.util.cancelGroupIfNeeded
import io.altenems.companion.android.common.util.getActiveNotification
...
import io.altenems.companion.android.common.util.tts.TextToSpeechData
...
import io.altenems.companion.android.database.settings.WebsocketSetting
import io.altenems.companion.android.sensors.LocationSensorManager
import io.altenems.companion.android.sensors.NotificationSensorManager
...
import io.altenems.companion.android.settings.assist.AssistConfigManager
import io.altenems.companion.android.settings.assist.DefaultAssistantManager
import io.altenems.companion.android.util.FlashlightHelper
import io.altenems.companion.android.util.PermissionRequestMediator
import io.altenems.companion.android.util.UrlUtil
import io.altenems.companion.android.vehicle.HaCarAppService
import io.altenems.companion.android.websocket.WebsocketManager
import io.altenems.companion.android.webview.WebViewActivity
import java.io.File
import java.net.URL
        ...
        when (message) {
            ...
            COMMAND_SCREEN_ON -> {
                ...
                val wakeLock = powerManager?.newWakeLock(
                    ...
                    "altenems::NotificationScreenOnWakeLock",
                )
