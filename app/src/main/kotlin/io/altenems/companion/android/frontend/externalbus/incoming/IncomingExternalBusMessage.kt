package io.altenems.companion.android.frontend.externalbus.incoming

import io.altenems.companion.android.common.util.UnknownJsonContent
import io.altenems.companion.android.common.util.UnknownJsonContentBuilder
import io.altenems.companion.android.common.util.UnknownJsonContentDeserializer
 ...
 *
 * The app should respond with an [io.altenems.companion.android.frontend.externalbus.outgoing.OutgoingExternalBusMessage] containing the capabilities.
 */
@Serializable
 ...
 * user is prompted to enter/scan a tag manually. Once handled, a [io.altenems.companion.android.frontend.externalbus.outgoing.SuccessResultMessage]
 ...
 * [io.altenems.companion.android.frontend.download.FrontendDownloadManager] via the external bus callback.
 ...
 * out-of-band with a stream of [io.altenems.companion.android.frontend.externalbus.outgoing.ImprovDiscoveredDeviceMessage]
 ...
 * [io.altenems.companion.android.frontend.externalbus.outgoing.ConfigResultMessage.ConfigResult.canSetupImprov] = `false`.
 */
@Serializable
 ...
 * provisioned — emit
 * [io.altenems.companion.android.frontend.externalbus.outgoing.ImprovDeviceSetupDoneMessage]
