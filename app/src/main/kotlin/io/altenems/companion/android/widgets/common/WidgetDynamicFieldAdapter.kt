package io.altenems.companion.android.widgets.common
...
import io.altenems.companion.android.databinding.WidgetButtonConfigureDynamicFieldBinding
...
class WidgetDynamicFieldAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (fieldKey == "entity_id" && entities.isNotEmpty()) {
            ...
            // or for altenems domain, which should be able
            ...
            if (domain == ("altenems") || domain == null) {
