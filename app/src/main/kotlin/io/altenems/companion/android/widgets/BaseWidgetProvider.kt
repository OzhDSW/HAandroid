package io.altenems.companion.android.widgets
...
import io.altenems.companion.android.database.widget.WidgetDao
...
abstract class BaseWidgetProvider<T : WidgetEntity<T>, DAO : WidgetDao<T>> : AppWidgetProvider() {
    ...
    companion object {
        const val UPDATE_VIEW =
            "io.altenems.companion.android.widgets.template.BaseWidgetProvider.UPDATE_VIEW"
        const val UPDATE_WIDGETS =
            "io.altenems.companion.android.widgets.UPDATE_WIDGETS"
