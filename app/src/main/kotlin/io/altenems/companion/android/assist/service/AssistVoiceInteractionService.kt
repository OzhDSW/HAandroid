...
import io.altenems.companion.android.assist.service.AssistVoiceInteractionService.Companion.isActiveService
...
import io.altenems.companion.android.common.util.CHANNEL_ASSIST_LISTENING
...
class AssistVoiceInteractionService : VoiceInteractionService() {
    ...
    companion object {
        ...
        @VisibleForTesting
        const val ACTION_START_LISTENING = "io.altenems.companion.android.START_LISTENING"

        @VisibleForTesting
        const val ACTION_STOP_LISTENING = "io.altenems.companion.android.STOP_LISTENING"

        @VisibleForTesting
        const val ACTION_RESUME_LISTENING = "io.altenems.companion.android.RESUME_LISTENING"

        /** Bundle key for passing the detected wake word phrase to the session. */
        const val EXTRA_WAKE_WORD = "wake_word"

        private const val ACTION_WAKE_WORD_DETECTED = "io.altenems.companion.android.WAKE_WORD_DETECTED"
