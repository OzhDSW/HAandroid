...
import io.altenems.companion.android.automotive.navigation.carAppActivity
import io.altenems.companion.android.automotive.navigation.navigateToCarAppActivity
...
import io.altenems.companion.android.frontend.navigation.frontendScreen
import io.altenems.companion.android.frontend.navigation.navigateToFrontend
import io.altenems.companion.android.launch.HAStartDestinationRoute
import io.altenems.companion.android.launch.PipReadiness
import io.altenems.companion.android.loading.LoadingScreen
import io.altenems.companion.android.loading.navigation.LoadingRoute
import io.altenems.companion.android.loading.navigation.loadingScreen
import io.altenems.companion.android.onboarding.OnboardingRoute
import io.altenems.companion.android.onboarding.WearOnboardApp
import io.altenems.companion.android.onboarding.WearOnboardingRoute
import io.altenems.companion.android.onboarding.locationforsecureconnection.navigation.URL_SECURITY_LEVEL_DOCUMENTATION
import io.altenems.companion.android.onboarding.onboarding
...
import io.altenems.companion.android.onboarding.wearOnboarding
import io.altenems.companion.android.settings.navigation.navigateToSettings
...
internal fun HANavHost(
    ...
    var serverUrl = (startDestination as? OnboardingRoute)?.urlToOnboard;
    if (serverUrl == null) serverUrl = stringArrayResource(R.array.servers_list).first()
