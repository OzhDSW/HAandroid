...
import io.altenems.companion.android.util.compose.altenemsGlanceTheme
import io.altenems.companion.android.util.compose.altenemsGlanceTypography
import io.altenems.companion.android.util.compose.glanceStringResource
import io.altenems.companion.android.widgets.todo.TodoState.Companion.getColors
...
private fun LoadingScreen() {
    Column(
        ...
        CircularProgressIndicator(
            ...
            modifier = GlanceModifier.size(altenemsGlanceTheme.dimensions.iconSize),
        )
    }
}
...
private fun EmptyScreen() {
    Column(
        ...
        Image(
            ...
            modifier = GlanceModifier.padding(bottom = 8.dp).size(altenemsGlanceTheme.dimensions.iconSize),
        )
        Text(
            text = glanceStringResource(commonR.string.widget_no_configuration),
            style = altenemsGlanceTypography.titleSmall.copy(textAlign = TextAlign.Center),
...
private fun EmptyContent() {
    Text(
        ...
        style = altenemsGlanceTypography.bodyMedium,
...
private fun TitleBar(listName: String?, serverId: Int, listEntityId: String, outOfSync: Boolean) {
    Row(
        ...
        Text(
            ...
            style = altenemsGlanceTypography.titleLarge,
            maxLines = 1,
            modifier = GlanceModifier.padding(end = 4.dp).defaultWeight(),
        )
        CircleIconButton(
            modifier = GlanceModifier.size(altenemsGlanceTheme.dimensions.iconSize).semantics {
                testTag = "Refresh"
            },
        ...
        SquareIconButton(
            modifier = GlanceModifier.size(altenemsGlanceTheme.dimensions.iconSize).semantics { testTag = "Add" },
...
private fun TodoItem(todoItem: TodoItemState) {
    var textStyle = altenemsGlanceTypography.bodySmall
