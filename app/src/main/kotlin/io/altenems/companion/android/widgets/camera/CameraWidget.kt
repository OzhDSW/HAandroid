...
import io.altenems.companion.android.util.hasActiveConnection
...
import io.altenems.companion.android.widgets.BaseWidgetProvider.Companion.UPDATE_WIDGETS
...
class CameraWidget : AppWidgetProvider() {
    ...
    companion object {
        internal const val UPDATE_IMAGE =
            "io.altenems.companion.android.widgets.camera.CameraWidget.UPDATE_IMAGE"
