...
import io.altenems.companion.android.common.util.cancelOnLifecycle
...
import io.altenems.companion.android.improv.ImprovRepository
...
import io.altenems.companion.android.util.UrlUtil.baseIsEqual
import io.altenems.companion.android.webview.externalbus.ExternalBusMessage
import io.altenems.companion.android.webview.externalbus.ExternalBusRepository
...
class WebViewPresenterImpl @Inject constructor(
    ...
    override fun checkSecurityVersion() {
        mainScope.launch {
            try {
                if (!serverManager.integrationRepository(serverId).isaltenemsVersionAtLeast(2021, 1, 5)) {
