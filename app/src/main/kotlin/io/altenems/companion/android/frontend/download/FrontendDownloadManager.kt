package io.altenems.companion.android.frontend.download
 ...
 *   via the external bus (arriving as a [io.altenems.companion.android.frontend.externalbus.incoming.HandleBlobMessage])
 ...
 *
 * The [handleBlob] method is called by the [io.altenems.companion.android.frontend.handler.FrontendMessageHandler]
...
class FrontendDownloadManager @Inject constructor(
     ...
     * as a [io.altenems.companion.android.frontend.externalbus.incoming.HandleBlobMessage].
