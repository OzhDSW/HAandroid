 ...
 */
const val ACTION_APPWIDGET_CREATED = "io.altenems.companion.android.widgets.APPWIDGET_CREATED"

/**
 * Should be a subtype of [io.altenems.companion.android.database.widget.WidgetEntity] to inject in the DAO with the
