...
import io.altenems.companion.android.common.data.websocket.impl.entities.GetTodosResponse.TodoItem.Companion.COMPLETED_STATUS
...
import io.altenems.companion.android.util.compose.glanceHaLightColors
    ...
    companion object {
        ...
        fun TodoState.getColors(): ColorProviders {
            return when (backgroundType) {
                ...
                WidgetBackgroundType.DAYNIGHT -> altenemsGlanceTheme.colors
