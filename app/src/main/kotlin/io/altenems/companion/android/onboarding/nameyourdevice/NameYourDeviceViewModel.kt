...
import io.altenems.companion.android.util.isPubliclyAccessible
import java.net.URL
 ...
 * directly to the phone app via [io.altenems.companion.android.onboarding.WearOnboardApp.Output].
 */
@HiltViewModel
