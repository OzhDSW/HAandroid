package io.altenems.companion.android.data.wear

import io.altenems.companion.android.common.util.WearDataMessages.DnsLookup.PATH_DNS_LOOKUP
import io.altenems.companion.android.common.util.WearDataMessages.DnsLookup.decodeDNSResult
import io.altenems.companion.android.common.util.WearDataMessages.DnsLookup.encodeDNSRequest
...
class WearDnsRequestListenerTest {
    private val testHostname = "altenems.local"

    private val altenemsLocal: InetAddress = InetAddress.getByAddress(testHostname, byteArrayOf(192.toByte(), 168.toByte(), 0, 23))
