...
import io.altenems.companion.android.common.bluetooth.BluetoothUtils
...
import io.altenems.companion.android.common.data.integration.containsWithAccuracy
...
import io.altenems.companion.android.common.util.DisabledLocationHandler
import io.altenems.companion.android.database.DatabaseEntryPoint
...
import io.altenems.companion.android.database.location.LocationHistoryItemResult
import io.altenems.companion.android.database.location.LocationHistoryItemTrigger
...
import io.altenems.companion.android.database.sensor.SensorSettingType
import io.altenems.companion.android.database.sensor.toSensorWithAttributes
import io.altenems.companion.android.location.HighAccuracyLocationService
import io.altenems.companion.android.notifications.MessagingManager
...
class LocationSensorManager :
    ...
    companion object {
        ...
        const val ACTION_REQUEST_LOCATION_UPDATES =
            "io.altenems.companion.android.background.REQUEST_UPDATES"
        const val ACTION_REQUEST_ACCURATE_LOCATION_UPDATE =
            "io.altenems.companion.android.background.REQUEST_ACCURATE_UPDATE"
        const val ACTION_PROCESS_LOCATION =
            "io.altenems.companion.android.background.PROCESS_UPDATES"
        const val ACTION_PROCESS_HIGH_ACCURACY_LOCATION =
            "io.altenems.companion.android.background.PROCESS_HIGH_ACCURACY_UPDATES"
        const val ACTION_PROCESS_GEO =
            "io.altenems.companion.android.background.PROCESS_GEOFENCE"
        const val ACTION_FORCE_HIGH_ACCURACY =
            "io.altenems.companion.android.background.FORCE_HIGH_ACCURACY"
