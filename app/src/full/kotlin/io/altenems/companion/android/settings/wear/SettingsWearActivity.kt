...
import io.altenems.companion.android.settings.wear.SettingsWearViewModel.Companion.CAPABILITY_WEAR_APP
import io.altenems.companion.android.settings.wear.views.SettingsWearMainView
import io.altenems.companion.android.settings.wear.views.SettingsWearOnboardingView
...
class SettingsWearActivity :
    ...
    private fun getAuthIntentUrl(): String? {
        return intent.data?.let {
            if (it.scheme == "altenems" && it.host == "wear-phone-signin") {
    ...
    companion object {
        private const val PLAY_STORE_APP_URI =
            "market://details?id=io.altenems.companion.android"
