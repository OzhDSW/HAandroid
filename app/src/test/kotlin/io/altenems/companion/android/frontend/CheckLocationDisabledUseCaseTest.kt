...
import io.altenems.companion.android.common.sensors.SensorManager.BasicSensor
...
class CheckLocationDisabledUseCaseTest {
    ...
    fun `Given location is disabled and sensor requires location when invoked then shows notification`() = runTest {
        ...
        val sensorManager: io.altenems.companion.android.common.sensors.SensorManager =
            mockk(relaxed = true)
