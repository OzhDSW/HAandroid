package io.altenems.companion.android.frontend.auth
    ...
    inner class MessageFormatting {
        ...
        private val context: android.content.Context = mockk {
            every { getString(any()) } answers {
                when (firstArg<Int>()) {
                    io.altenems.companion.android.common.R.string.required_fields -> "requires a username and password."
                    io.altenems.companion.android.common.R.string.not_private -> "Your connection to this site is not private."
                    else -> ""
                }
            }
        }
