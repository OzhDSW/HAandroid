package io.altenems.companion.android.assist.service
...
import io.altenems.companion.android.assist.service.AssistVoiceInteractionService.Companion.ACTION_RESUME_LISTENING
import io.altenems.companion.android.assist.service.AssistVoiceInteractionService.Companion.ACTION_START_LISTENING
import io.altenems.companion.android.assist.service.AssistVoiceInteractionService.Companion.ACTION_STOP_LISTENING
import io.altenems.companion.android.assist.wakeword.MicroWakeWordModelConfig
import io.altenems.companion.android.assist.wakeword.WakeWordListener
import io.altenems.companion.android.assist.wakeword.WakeWordListenerFactory
...
import io.altenems.companion.android.util.microWakeWordModelConfigs
...
class AssistVoiceInteractionServiceTest {
    ...
    fun `Given wake word detected when callback invoked then send broadcast`() = runTest {
        ...
        val wakeWordBroadcast = broadcastIntents.find {
            it.action == "io.altenems.companion.android.WAKE_WORD_DETECTED"
        }
    ...
    private fun assertAction(action: String, actionFunction: (Context) -> Unit) {
        ...
        every { context.packageName } returns "io.altenems.companion.android"
        ...
        assertEquals("io.altenems.companion.android", intentSlot.captured.`package`)
    }
}
