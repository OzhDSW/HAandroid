package io.altenems.companion.android.onboarding.nameyourdevice.navigation
...
import io.altenems.companion.android.onboarding.nameyourdevice.NameYourDeviceNavigationEvent
import io.altenems.companion.android.onboarding.nameyourdevice.NameYourDeviceViewModel
...
internal class NameYourDeviceNavigationTest : BaseOnboardingNavigationTest() {
    ...
    private fun testDeviceNamedWithPublicUrl(hasPlainTextAccess: Boolean) {
        ...
        testNavigation {
            navController.navigateToNameYourDevice("http://altenems.local", "code")
            assertTrue(navController.currentBackStackEntry?.destination?.hasRoute<NameYourDeviceRoute>() == true)
