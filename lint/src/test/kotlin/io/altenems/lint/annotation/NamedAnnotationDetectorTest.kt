package io.altenems.lint.annotation
...
class NamedAnnotationDetectorTest {
    ...
    private val customQualifierStub = kotlin(
        """
        package io.altenems.companion.android.di.qualifiers
    ...
    fun `Given a class using @Named annotation then NoNamedAnnotation issue is raised`() {
        lint().issues(NamedAnnotationDetector.ISSUE)
            ...
            .expect(
                """
                src/io/altenems/companion/android/data/MyRepository.kt:7: Error: Usage of @Named is forbidden. Use a custom qualifier annotation instead. [NoNamedAnnotation]
                    @Named("server_url") private val serverUrl: String
                    ~~~~~~~~~~~~~~~~~~~~
                1 error
                """.trimIndent(),
        ...
        lint().issues(NamedAnnotationDetector.ISSUE)
            ...
            .files(
                ...
                kotlin(
                    ...
                    import javax.inject.Inject
                    import io.altenems.companion.android.di.qualifiers.MyCustomQualifier
