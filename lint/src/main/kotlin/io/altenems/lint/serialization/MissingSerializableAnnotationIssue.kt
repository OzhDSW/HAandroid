...
import io.altenems.lint.serialization.MissingSerializableAnnotationIssue.RECOMMENDATION
import io.altenems.lint.utils.Logger
...
private val ANY_SERIALIZER_TYPES = listOf(
    "io.altenems.companion.android.common.util.AnySerializer",
    "io.altenems.companion.android.common.util.MapAnySerializer",
)
