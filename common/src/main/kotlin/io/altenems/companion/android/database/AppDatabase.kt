...
import io.altenems.companion.android.database.location.LocationHistoryItem
import io.altenems.companion.android.database.migration.Migration27to28
import io.altenems.companion.android.database.migration.Migration36to37
...
import io.altenems.companion.android.database.sensor.Attribute
import io.altenems.companion.android.database.sensor.EntriesTypeConverter
import io.altenems.companion.android.database.sensor.Sensor
import io.altenems.companion.android.database.sensor.SensorDao
import io.altenems.companion.android.database.sensor.SensorSetting
import io.altenems.companion.android.database.sensor.SensorSettingTypeConverter
...
import io.altenems.companion.android.database.settings.LocalNotificationSettingConverter
import io.altenems.companion.android.database.settings.LocalSensorSettingConverter
import io.altenems.companion.android.database.settings.Setting
import io.altenems.companion.android.database.settings.SettingsDao
import io.altenems.companion.android.database.wear.CameraTile
import io.altenems.companion.android.database.wear.CameraTileDao
import io.altenems.companion.android.database.wear.EntityStateComplications
import io.altenems.companion.android.database.wear.EntityStateComplicationsDao
import io.altenems.companion.android.database.wear.FavoriteCaches
import io.altenems.companion.android.database.wear.FavoriteCachesDao
import io.altenems.companion.android.database.wear.Favorites
import io.altenems.companion.android.database.wear.FavoritesDao
import io.altenems.companion.android.database.wear.ThermostatTile
...
import io.altenems.companion.android.database.widget.ButtonWidgetEntity
import io.altenems.companion.android.database.widget.CameraWidgetDao
import io.altenems.companion.android.database.widget.CameraWidgetEntity
import io.altenems.companion.android.database.widget.MediaPlayerControlsWidgetDao
import io.altenems.companion.android.database.widget.MediaPlayerControlsWidgetEntity
import io.altenems.companion.android.database.widget.StaticWidgetDao
import io.altenems.companion.android.database.widget.StaticWidgetEntity
import io.altenems.companion.android.database.widget.TemplateWidgetDao
import io.altenems.companion.android.database.widget.TemplateWidgetEntity
...
import io.altenems.companion.android.database.widget.WidgetBackgroundTypeConverter
import io.altenems.companion.android.database.widget.WidgetTapActionConverter
