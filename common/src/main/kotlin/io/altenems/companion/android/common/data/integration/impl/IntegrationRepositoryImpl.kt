package io.altenems.companion.android.common.data.integration.impl

import androidx.annotation.VisibleForTesting
import dagger.assisted.Assisted
import dagger.assisted.AssistedInject
import io.altenems.companion.android.common.BuildConfig
import io.altenems.companion.android.common.data.altenemsVersion
import io.altenems.companion.android.common.data.LocalStorage
import io.altenems.companion.android.common.data.integration.Action
import io.altenems.companion.android.common.data.integration.DeviceRegistration
import io.altenems.companion.android.common.data.integration.Entity
import io.altenems.companion.android.common.data.integration.IntegrationException
import io.altenems.companion.android.common.data.integration.IntegrationRepository
import io.altenems.companion.android.common.data.integration.SensorRegistration
import io.altenems.companion.android.common.data.integration.UpdateLocation
import io.altenems.companion.android.common.data.integration.impl.entities.ActionRequest
import io.altenems.companion.android.common.data.integration.impl.entities.CallServiceIntegrationRequest
import io.altenems.companion.android.common.data.integration.impl.entities.EntityResponse
import io.altenems.companion.android.common.data.integration.impl.entities.FireEventIntegrationRequest
import io.altenems.companion.android.common.data.integration.impl.entities.FireEventRequest
import io.altenems.companion.android.common.data.integration.impl.entities.GetConfigIntegrationRequest
import io.altenems.companion.android.common.data.integration.impl.entities.GetZonesIntegrationRequest
import io.altenems.companion.android.common.data.integration.impl.entities.IntegrationRequest
import io.altenems.companion.android.common.data.integration.impl.entities.RateLimitRequest
import io.altenems.companion.android.common.data.integration.impl.entities.RateLimitResponse
import io.altenems.companion.android.common.data.integration.impl.entities.RegisterDeviceIntegrationRequest
import io.altenems.companion.android.common.data.integration.impl.entities.RegisterDeviceRequest
import io.altenems.companion.android.common.data.integration.impl.entities.RegisterSensorIntegrationRequest
import io.altenems.companion.android.common.data.integration.impl.entities.RenderTemplateIntegrationRequest
import io.altenems.companion.android.common.data.integration.impl.entities.ScanTagIntegrationRequest
import io.altenems.companion.android.common.data.integration.impl.entities.SensorRegistrationRequest
import io.altenems.companion.android.common.data.integration.impl.entities.SensorUpdateRequest
import io.altenems.companion.android.common.data.integration.impl.entities.Template
import io.altenems.companion.android.common.data.integration.impl.entities.UpdateLocationIntegrationRequest
import io.altenems.companion.android.common.data.integration.impl.entities.UpdateLocationRequest
import io.altenems.companion.android.common.data.integration.impl.entities.UpdateSensorStatesIntegrationRequest
import io.altenems.companion.android.common.data.servers.ServerManager
import io.altenems.companion.android.common.data.servers.firstUrlOrNull
import io.altenems.companion.android.common.data.servers.tryOnUrls
import io.altenems.companion.android.common.data.websocket.WebSocketRepository
...
import io.altenems.companion.android.common.data.websocket.impl.entities.GetConfigResponse
...
import io.altenems.companion.android.common.util.isNullOrBlank
import io.altenems.companion.android.database.server.Server
import io.altenems.companion.android.di.qualifiers.NamedDeviceId
import io.altenems.companion.android.di.qualifiers.NamedIntegrationStorage
import io.altenems.companion.android.di.qualifiers.NamedManufacturer
import io.altenems.companion.android.di.qualifiers.NamedModel
import io.altenems.companion.android.di.qualifiers.NamedOsVersion
...
class IntegrationRepositoryImpl @AssistedInject constructor(
    ...
    companion object {
        private const val APP_ID = "io.altenems.companion.android"
        private const val APP_NAME = "Alten"
    ...
    override suspend fun getaltenemsVersion(): String {
    ...
    override suspend fun isaltenemsVersionAtLeast(year: Int, month: Int, release: Int): Boolean {
        if (!server().connection.isRegistered) return false

        val version = altenemsVersion.fromString(getaltenemsVersion())
