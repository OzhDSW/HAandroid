package io.altenems.companion.android.common.sensors
...
import io.altenems.companion.android.common.util.CHANNEL_SENSOR_SYNC
...
import io.altenems.companion.android.database.sensor.SensorWithAttributes
import io.altenems.companion.android.database.sensor.toSensorWithAttributes
import io.altenems.companion.android.database.sensor.toSensorsWithAttributes
...
abstract class SensorReceiverBase : BroadcastReceiver() {
    companion object {
        const val ACTION_UPDATE_SENSOR = "io.altenems.companion.android.UPDATE_SENSOR"
        const val ACTION_UPDATE_SENSORS = "io.altenems.companion.android.UPDATE_SENSORS"
        const val ACTION_STOP_BEACON_SCANNING = "io.altenems.companion.android.STOP_BEACON_SCANNING"
    ...
    private suspend fun syncSensorsWithServer(
        ...
        val currentHAversion = integrationRepository.getaltenemsVersion()
        val supportsDisabledSensors = integrationRepository.isaltenemsVersionAtLeast(2022, 6, 0)
